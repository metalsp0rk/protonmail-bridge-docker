...
![version badge](https://img.shields.io/docker/v/metalsp0rk/protonmail-bridge)
![image size badge](https://img.shields.io/docker/image-size/metalsp0rk/protonmail-bridge/build)
![docker pulls badge](https://img.shields.io/docker/pulls/metalsp0rk/protonmail-bridge)
![deb badge](https://github.com/metalsp0rk/protonmail-bridge-docker/workflows/pack%20from%20deb/badge.svg)
![build badge](https://github.com/metalsp0rk/protonmail-bridge-docker/workflows/build%20from%20source/badge.svg)
...
GitHub: [https://github.com/metalsp0rk/protonmail-bridge-docker](https://github.com/metalsp0rk/protonmail-bridge-docker)
...
```
docker run --rm -it -v protonmail:/root ghcr.io/metalsp0rk/protonmail-bridge init
```
...
```
docker run -d --name=protonmail-bridge -v protonmail:/root -p 1025:25/tcp -p 1143:143/tcp --restart=unless-stopped ghcr.io/metalsp0rk/protonmail-bridge
```
...
```
docker run -d --name=protonmail-bridge -v protonmail:/root -p 127.0.0.1:1025:25/tcp -p 127.0.0.1:1143:143/tcp --restart=unless-stopped ghcr.io/metalsp0rk/protonmail-bridge
```
